 ...
 */
class LimechatWidgetViewRefactored @JvmOverloads constructor(
    context: Context,
    ...
    private fun setupWebView() {
        ...
        webView = webViewManager?.createHardenedWebView()?.also { webView ->
    ...
    private fun updateState(newState: WidgetState) {
        ...
        Log.d(TAG, "State updated: isReady=${newState.isReady}, isLoaded=${newState.isLoaded}, hasError=${newState.hasError}")
    }
